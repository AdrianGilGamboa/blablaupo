    ...
    <head>
        ...
        <s:if test="%{#session.logado=='si'}">
            <div class="container">
                ...
                <s:form name="Mis Viajes Reservados" action="verMisViajesReservados" cssStyle="padding-top:0px;padding-bottom:0px;margin-top:3%;">
                    <s:submit name="verMisViajesReservados" value="Viajes Reservados" cssClass="btn btn-primary btn-block"></s:submit>
                </s:form>
